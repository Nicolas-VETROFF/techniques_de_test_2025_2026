...
La méthode "Tests First" a été utilisée pour tester les fonctions principales du projet avant de les implémenter.
...
Ensuite, j'ai eu du mal à comprendre comment fonctionnait le mock et comment il devait être utilisé en python.
